...
export const rsvpTexts = {
  ...
  childGuestLabel: "Este invitado es un niño",
  childMenuQuestion: "Si es un niño, indica su opción de comida:",
  childMenuKids: "Comerá menú de niños",
  childMenuOwn: "Llevará su propia comida",
  busQuestionFallback: "¿Este invitado utilizará el autobús privado?",
  busQuestionPrefix: "¿",
  busQuestionSuffix: " utilizará el autobús privado?",
  busYes: "Sí",
  busNo: "No",
